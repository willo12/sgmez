...
ADMINS = (
    # ('Willem Sijp', 'wim.sijp@gmail.com'),
)
MANAGERS = ADMINS

# Hosts/domain names that are valid for this site; required if DEBUG is False
# See https://docs.djangoproject.com/en/1.5/ref/settings/#allowed-hosts
ALLOWED_HOSTS = ['localhost','.local','willospace.pythonanywhere.com','willospace.pythonanywhere.com/sgdata']
...
INSTALLED_APPS = (
	"wpstestmez",    # made this for the codehilite.css stylesheet
	"mezzanine_pagedown",
    "sgdata",
